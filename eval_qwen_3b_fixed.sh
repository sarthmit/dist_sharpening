...
run_name="fixed_${model_slug}_${mode}_${alpha}_${beta_inv}_${weight}_${normalization}"
...
eval_config="examples/configs/dist_sharpening/eval_math_lighteval_fixed.yaml"
