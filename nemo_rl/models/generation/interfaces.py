...
class GenerationConfig(TypedDict):
    ...
    # If True, do not use eos_token_id as a stop criterion.
    # When combined with explicit stop_token_ids, eos will be removed if present.
    ignore_eos_token: NotRequired[bool]
